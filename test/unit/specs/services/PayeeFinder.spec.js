...
describe('PayeeFinder', () => {
  ...
  it('should return correct payee when using regexp', () => {
    assert.equal(payeeFinder.findBasedOnLabel('Medecins Sans Frontieres\n Account 39480098').payee, 'P3')
  })
  ...
  it('should return no payee', () => {
    ...
    assert.isNull(payeeFinder.findBasedOnLabel('Versement Medecins Sans\n Frontieres'))
  })
